...
if __name__ == '__main__':
    AUTH_KEYS = (os.environ["auth_key_dandan"], os.environ["auth_key_pipi"], os.environ["auth_key_yixin"], os.environ["auth_key_muochi"], os.environ["auth_key_yu"], os.environ["auth_key_morong"])
